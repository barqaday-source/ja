...
const LOCAL_PRODUCTS: ShoppingProduct[] = [
  { id: "p-1", name: "قميص كلاسيك", description: "قميص رسمي مريح باللون الأسود والأبيض", price: 45_000, quantity: 34, category: "ملابس وأزياء", sku: "SH-001", imageUrl: REAL_IMAGES.products.shirt, companyName: "المتجر", companyId: "abu-ali", companyWhatsapp: "9647700000000", location: "الكرادة، بغداد", isSponsored: true, isVerified: true },
  { id: "p-2", name: "جاكيت رسمي", description: "جاكيت أنيق باللون الكحلي والرمادي", price: 85_000, quantity: 4, category: "ملابس وأزياء", sku: "SH-002", imageUrl: REAL_IMAGES.products.suit, companyName: "المتجر", companyId: "abu-ali", companyWhatsapp: "9647700000000", location: "الكرادة، بغداد", isVerified: true },
