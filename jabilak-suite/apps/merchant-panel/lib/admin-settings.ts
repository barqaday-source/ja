...
export const PREVIEW_ADMIN_SETTINGS: AdminManagedSettings = {
  ...
  promotionalPlans: [
    { days: 3, label: "3 أيام", amount: 5_000, currency: "IQD", placement: "top_carousel", rankingLabel: "أولوية التوصية حسب المنطقة والفئة في بحث المنتجات" },
  ],
  subscriptionPlans: [
    ...
    { id: "standard", name: "باقة التاجر (Standard)", price: 15_000, currency: "IQD", period: "شهرياً", features: ["مخزن ضخم مفتوح", "دفتر ديون غير محدود", "ظهور في بحث المنتجات"] },
