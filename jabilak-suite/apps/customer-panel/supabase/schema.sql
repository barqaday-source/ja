...
create table if not exists public.messages (
  ...
  check (kind <> 'file' or (file_name is not null and mime_type is not null and file_size_bytes is not null and attachment_path is not null))
);
...
-- بحث المنتجات: بحث المنتجات النصي المباشر عبر Postgres Full-Text Search.
