...
const STORES: StoreResult[] = [
  { kind: "store", id: "abu-ali", name: "أبو علي للأقمشة", detail: "ملابس · الكرادة، بغداد", product: "قميص قطني رجالي", productType: "ملابس", price: "120,000 د.ع", rating: "4.8", verified: true, color: "#443C50" },
  { kind: "store", id: "al-amir", name: "الأمير للإلكترونيات", detail: "إلكترونيات · الكرادة، بغداد", product: "سماعات لاسلكية", productType: "إلكترونيات", price: "85,000 د.ع", rating: "4.6", verified: true, color: "#655B77" },
  { kind: "store", id: "zad", name: "زاد للمأكولات", detail: "مواد غذائية · الجادرية، بغداد", product: "سلة مواد غذائية", productType: "أطعمة", price: "75,000 د.ع", rating: "4.7", verified: false, color: "#81B7EC" },
  { kind: "store", id: "noor", name: "نور للذهب", detail: "مجوهرات · المنصور، بغداد", product: "سوار هدية", productType: "مجوهرات", price: "250,000 د.ع", rating: "4.9", verified: true, color: "#968A98" },
  { kind: "store", id: "step-style", name: "ستيب ستايل", detail: "أحذية · المنصور، بغداد", product: "أحذية رياضية بيضاء", productType: "أحذية", price: "75,000 د.ع", rating: "4.8", verified: true, color: "#81B7EC" },
];

const POSTS: PostResult[] = [
  { kind: "post", id: "post-shirt-summer", productId: "shirt", shopId: "abu-ali", shop: "أبو علي للأقمشة", title: "قمصان صيفية بقصة نظيفة", caption: "ألوان هادئة وخامات مريحة للدوام والمشاوير اليومية.", product: "قميص قطني رجالي", productType: "ملابس", price: "120,000 د.ع", rating: "4.8", location: "الكرادة، بغداد", image: REAL_IMAGES.products.shirt, verified: true, likes: "1.2K" },
  { kind: "post", id: "post-suit-evening", productId: "suit", shopId: "abu-ali", shop: "أبو علي للأقمشة", title: "إطلالة رسمية بدون مبالغة", caption: "بدلة أنيقة بقماش خفيف وتفاصيل مصممة للمناسبات.", product: "بدلة رسمية", productType: "ملابس", price: "280,000 د.ع", rating: "4.9", location: "المنصور، بغداد", image: REAL_IMAGES.products.suit, verified: true, likes: "860" },
  { kind: "post", id: "post-fashion-edit", productId: "fashion-edit", shopId: "abu-ali", shop: "أبو علي للأقمشة", title: "اختيارات هذا الأسبوع", caption: "تشكيلة يومية مختارة من المتجر مع حجز سريع عبر واتساب.", product: "تشكيلة ملابس يومية", productType: "ملابس", price: "من 75,000 د.ع", rating: "4.7", location: "بغداد", image: REAL_IMAGES.posts.model, verified: true, likes: "2.4K" },
  { kind: "post", id: "post-sneakers", productId: "shoes", shopId: "step-style", shop: "ستيب ستايل", title: "حذاء المدينة المريح", caption: "ألوان عملية ومقاسات متوفرة للرجال والنساء.", product: "أحذية رياضية بيضاء", productType: "أحذية", price: "75,000 د.ع", rating: "4.8", location: "المنصور، بغداد", image: REAL_IMAGES.products.shoes, verified: true, likes: "1.8K" },
  { kind: "post", id: "post-watch", productId: "watch", shopId: "al-amir", shop: "الأمير للإلكترونيات", title: "ساعة ذكية بتصميم خفيف", caption: "بطارية طويلة وشكل يناسب المكتب والرياضة.", product: "ساعة ذكية", productType: "إلكترونيات", price: "85,000 د.ع", rating: "4.6", location: "الكرادة، بغداد", image: REAL_IMAGES.products.watch, verified: true, likes: "640" },
];
