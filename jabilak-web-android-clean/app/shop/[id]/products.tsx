...
const PRODUCTS = [
  { id: "shirt", name: "قميص كلاسيك", price: 120000, rating: 4.8, sold: 182, created: 4, available: true, color: "#443C50" },
  { id: "suit", name: "جاكيت رسمي", price: 250000, rating: 4.9, sold: 246, created: 3, available: true, color: "#655B77" },
  { id: "jeans", name: "بنطال جينز", price: 150000, rating: 4.7, sold: 208, created: 2, available: true, color: "#81B7EC" },
  { id: "shirt-2", name: "تي شيرت قطني", price: 80000, rating: 4.6, sold: 97, created: 1, available: false, color: "#968A98" },
  { id: "coat", name: "معطف شتوي", price: 320000, rating: 4.8, sold: 152, created: 5, available: true, color: "#1A1821" },
  { id: "shoes", name: "حذاء جلد طبيعي", price: 180000, rating: 4.5, sold: 76, created: 6, available: true, color: "#8E765D" },
];
  ...
  const header = (
    <View>
      <View style={styles.topBar}>
        ...
        <View style={styles.companyHeading}><View style={styles.companyNameRow}><Text style={[styles.companyName, { color: colors.foreground }]}>شركة الأناقة للملابس</Text><MaterialIcons name="verified" size={16} color={colors.primary} /></View><Text style={[styles.companySub, { color: colors.muted }]}>42 منتجاً · بغداد</Text></View><View style={[styles.companyAvatar, { backgroundColor: colors.primary }]}><Text style={styles.avatarText}>أ</Text></View>
      </View>
