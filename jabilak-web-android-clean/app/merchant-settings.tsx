...
const INITIAL_DAYS: Day[] = [
  { id: "sat", name: "السبت", open: true, from: "09:00 ص", to: "10:00 م" },
  { id: "sun", name: "الأحد", open: true, from: "09:00 ص", to: "10:00 م" },
  { id: "mon", name: "الإثنين", open: true, from: "09:00 ص", to: "10:00 م" },
  { id: "tue", name: "الثلاثاء", open: true, from: "09:00 ص", to: "10:00 م" },
  { id: "wed", name: "الأربعاء", open: true, from: "09:00 ص", to: "10:00 م" },
  { id: "thu", name: "الخميس", open: true, from: "09:00 ص", to: "10:00 م" },
  { id: "fri", name: "الجمعة", open: false, from: "09:00 ص", to: "10:00 م" },
];

export default function MerchantSettingsScreen() {
  const colors = useColors();
  const router = useRouter();
  const [avatarUri, setAvatarUri] = useState<string | undefined>(REAL_IMAGES.stores.boutique);
  ...
  const { busy: saving, run: runSave } = useMockAction();
  const { busy: uploading, run: runUpload } = useMockAction(500);
  const { busy: savingPassword, run: runSavePassword } = useMockAction();
