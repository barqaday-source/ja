...
const MEDIA_POOL = [REAL_IMAGES.posts.lifestyle, REAL_IMAGES.posts.retail, REAL_IMAGES.posts.model, REAL_IMAGES.products.shirt, REAL_IMAGES.products.suit, REAL_IMAGES.products.watch, REAL_IMAGES.products.shoes, REAL_IMAGES.products.bag];

export default function PublishScreen() {
  const router = useRouter();
  const colors = useColors();
  const { run, busy } = useMockAction(700);
