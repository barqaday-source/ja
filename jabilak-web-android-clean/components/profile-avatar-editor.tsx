...
const MOCK_AVATARS = [
  { id: "fashion", uri: REAL_IMAGES.posts.model, label: "صورة شخصية" },
  { id: "store", uri: REAL_IMAGES.stores.boutique, label: "صورة المتجر" },
  { id: "lifestyle", uri: REAL_IMAGES.posts.lifestyle, label: "صورة عصرية" },
];
